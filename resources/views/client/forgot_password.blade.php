    ...
    <div class="col-md-6 loginright">
        <div class="container">
            <div class="mw-450 text-center">
                <h4>New Client? <a href="{{url('/client_signup')}}">Sign up</a></h4>
                        ...
                        <div class="box-pricing-item text-center">
                            <div>
                                <span class="for-month display-month" style="width: 100%;">
                                    <form class="contact-form-style" id="contact-form" action="{{route('client_forgot_password')}}" method="post">
                                        @csrf
                                        <div class="row">                                            
                                            ...
                                            <div class="col-lg-12 col-md-12 text-center">
                                                <button class="submit submit-auto-width btn btn-default" type="submit">Send Link</button>
