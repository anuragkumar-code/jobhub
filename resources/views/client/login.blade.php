    ...
    <div class="col-md-6 loginright">
        ...
        <div class="container">
            ...
            <div class="mw-450 text-center">
                ...
                <h4>New User? <a href="{{url('/client_signup')}}">Sign up</a></h4>
                        ...
                        <div class="box-pricing-item text-center">
                            ...
                            <div>
                                ...
                                <span class="for-month display-month" style="width: 100%;">
                                    ...
                                    <form class="contact-form-style" id="contact-form" action="{{route('client_loggedin')}}" method="post">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 col-md-12">
                                                ...
                                                <div class="input-style mb-20" style="text-align: right;">
                                                    ...
                                                    <a href="{{url('/client_forgot_password')}}">Forgot Password?</a>
