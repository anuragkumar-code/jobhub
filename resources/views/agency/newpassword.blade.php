    ...
    <div class="col-md-6 loginright">
        <div class="container">
            <div class="mw-450 text-center">
                <h4>Want to login in your account? <a href="{{url('/agency_login')}}">Login</a></h4>
                        ...
                        <div class="box-pricing-item text-center">
                            <div>
                                <span class="for-month display-month" style="width: 100%;">
                                    <form class="contact-form-style signupform" id="contact-form" action="{{route('updatePassword')}}" method="post">
                                        @csrf
                                        <div class="row">
