    ...
    <div class="col-md-6 loginright">
        ...
        <div class="container">
            ...
            <div class="mw-450 text-center">
                ...
                <h4>Already have an account? <a href="{{url('/agency_login')}}">Login</a></h4>
                        ...
                        <div class="box-pricing-item text-center">
                            ...
                            <div>
                                ...
                                <span class="for-month display-month" style="width: 100%;">
                                    ...
                                    <form class="contact-form-style signupform" id="contact-form" action="{{route('agency_registered')}}" method="post">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6">
                                                ...
                                                <div class="input-style mb-20">
                                                    ...
                                                    <input name="company_name" placeholder="Company Name" value="{{old('company_name')}}" type="Email *">
                                            ...
                                            <div class="col-lg-6 col-md-6">
                                                ...
                                                <div class="input-style mb-20">
                                                    ...
                                                    <input name="email" placeholder="Company Email" value="{{old('email')}}" type="Email *">
                                            ...
                                            <div class="col-lg-12 col-md-12">
                                                ...
                                                <div class="input-style mb-20">
                                                    ...
                                                    <input name="company_website" placeholder="Company Website link" value="{{old('company_website')}}" type="Email *">
